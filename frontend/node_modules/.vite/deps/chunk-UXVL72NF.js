...
function $490ce42ff92ff39b$var$getName(el, role) {
  ...
  if (tag === "input" || tag === "textarea" || tag === "select") {
    ...
    if (wrappingLabel == null ? void 0 : wrappingLabel.textContent) return $490ce42ff92ff39b$var$truncate(wrappingLabel.textContent);
...
function $490ce42ff92ff39b$var$getValue(el) {
  ...
  if (el instanceof HTMLSelectElement) {
    ...
    const text = (_a = selected == null ? void 0 : selected.text) == null ? void 0 : _a.trim();
    if (text) return text;
    return el.value || void 0;
  }
  return void 0;
...
var $364c127d152b1085$export$8f7f86a77535f7a3 = class extends $364c127d152b1085$var$RTVIEventEmitter {
  constructor(options) {
    ...
    const wrappedCallbacks = {
      ...
      onUnsupportedFeature: (error) => {
        var _a, _b;
        (_b = (_a = options == null ? void 0 : options.callbacks) == null ? void 0 : _a.onUnsupportedFeature) == null ? void 0 : _b.call(_a, error);
      ...
      onCamUpdated: (cam) => {
        var _a, _b;
        if (cam == null ? void 0 : cam.deviceId) this._markDeviceGranted("cam");
      ...
      onMicUpdated: (mic) => {
        var _a, _b;
        if (mic == null ? void 0 : mic.deviceId) this._markDeviceGranted("mic");
      ...
      onBotTranscript: (text) => {
        var _a, _b, _c;
        const hasSubscriber = !!((_a = options == null ? void 0 : options.callbacks) == null ? void 0 : _a.onBotTranscript) || this.listenerCount((0, $c1b4da4af54f4fa1$export$6b4624d233c61fcb).BotTranscript) > 0;
        ...
        (_c = (_b = options == null ? void 0 : options.callbacks) == null ? void 0 : _b.onBotTranscript) == null ? void 0 : _c.call(_b, text);
  ...
  _setMediaState(patch) {
    ...
    (_b = (_a = this._options.callbacks) == null ? void 0 : _a.onMediaStateChanged) == null ? void 0 : _b.call(_a, this.mediaState);
  ...
  async _enrichFromPermissionsAPI() {
    var _a;
    const permissions = (_a = globalThis.navigator) == null ? void 0 : _a.permissions;
    if (!(permissions == null ? void 0 : permissions.query)) return;
  ...
  get selectedCam() {
    ...
    try {
      ...
      if (e instanceof $db6391dc7d757577$export$bd0820eb8444fcd9) {
        (_b = (_a = this._options.callbacks) == null ? void 0 : _a.onUnsupportedFeature) == null ? void 0 : _b.call(_a, e);
        return {};
      }
      throw e;
    }
  ...
  enableCam(enable) {
    ...
    try {
      ...
      if (e instanceof $db6391dc7d757577$export$bd0820eb8444fcd9) (_b = (_a = this._options.callbacks) == null ? void 0 : _a.onUnsupportedFeature) == null ? void 0 : _b.call(_a, e);
      else throw e;
    }
  }
  get isCamEnabled() {
  ...
  stopUISnapshotStream() {
    var _a;
    (_a = this._uiSnapshotStreamer) == null ? void 0 : _a.stop();
  ...
  handleMessage(ev) {
    ...
    switch (ev.type) {
      ...
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).USER_LLM_TEXT: {
        ...
        (_w = (_v = this._options.callbacks) == null ? void 0 : _v.onUserLlmText) == null ? void 0 : _w.call(_v, llmTextData);
      ...
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).BOT_OUTPUT:
        (_y = (_x = this._options.callbacks) == null ? void 0 : _x.onBotOutput) == null ? void 0 : _y.call(_x, ev.data);
        break;
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).BOT_TRANSCRIPTION:
        (_A = (_z = this._options.callbacks) == null ? void 0 : _z.onBotTranscript) == null ? void 0 : _A.call(_z, ev.data);
        break;
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).BOT_LLM_TEXT:
        (_C = (_B = this._options.callbacks) == null ? void 0 : _B.onBotLlmText) == null ? void 0 : _C.call(_B, ev.data);
        break;
      ...
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).SERVER_MESSAGE:
        (_Q = (_P = this._options.callbacks) == null ? void 0 : _P.onServerMessage) == null ? void 0 : _Q.call(_P, ev.data);
      ...
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).UI_COMMAND: {
        const data = ev.data;
        (_S = (_R = this._options.callbacks) == null ? void 0 : _R.onUICommand) == null ? void 0 : _S.call(_R, data);
      ...
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).UI_JOB_GROUP: {
        const data = ev.data;
        (_U = (_T = this._options.callbacks) == null ? void 0 : _T.onUIJobGroup) == null ? void 0 : _U.call(_T, data);
      ...
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).LLM_FUNCTION_CALL_STARTED: {
        const data = ev.data;
        (_W = (_V = this._options.callbacks) == null ? void 0 : _V.onLLMFunctionCallStarted) == null ? void 0 : _W.call(_V, data);
      ...
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).LLM_FUNCTION_CALL_IN_PROGRESS: {
        ...
        (_Y = (_X = this._options.callbacks) == null ? void 0 : _X.onLLMFunctionCallInProgress) == null ? void 0 : _Y.call(_X, data);
      ...
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).LLM_FUNCTION_CALL_STOPPED: {
        const data = ev.data;
        (__ = (_Z = this._options.callbacks) == null ? void 0 : _Z.onLLMFunctionCallStopped) == null ? void 0 : __.call(_Z, data);
      ...
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).LLM_FUNCTION_CALL: {
        ...
        if ((_$ = this._options.callbacks) == null ? void 0 : _$.onLLMFunctionCall) {
        ...
        (_ba = (_aa = this._options.callbacks) == null ? void 0 : _aa.onLLMFunctionCall) == null ? void 0 : _ba.call(_aa, data);
      ...
      case (0, $c0d10c4690969999$export$38b3db05cbf0e240).BOT_LLM_SEARCH_RESPONSE: {
        const data = ev.data;
        (_da = (_ca = this._options.callbacks) == null ? void 0 : _ca.onBotLlmSearchResponse) == null ? void 0 : _da.call(_ca, data);
...
export {
  ...
  $490ce42ff92ff39b$export$5174ac1454ce16bc,
  $490ce42ff92ff39b$export$e702c6c416f7c8de,
  $490ce42ff92ff39b$export$326b5f56ac5b6149,
  $4a4f32f44a93ea38$export$d1b25383c8328718,
...
bowser/src/bowser.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UXVL72NF.js.map
